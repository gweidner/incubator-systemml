...
public class RmmSPInstruction extends BinarySPInstruction 
{
	...
	private static class RmmReplicateFunction implements PairFlatMapFunction<Tuple2<MatrixIndexes, MatrixBlock>, TripleIndexes, MatrixBlock> 
	{
		...
		@Override
		public LazyIterableIterator<Tuple2<TripleIndexes, MatrixBlock>> call( Tuple2<MatrixIndexes, MatrixBlock> arg0 ) 
			throws Exception 
		{
			...
			return (LazyIterableIterator<Tuple2<TripleIndexes, MatrixBlock>>) ret.iterator();
		}
	}
